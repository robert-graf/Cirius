...
public class TileSetXML_outdated extends XML {
	/**
	 * @author rubberOo E: Diese Klasse lädt TileSet ein (read()) oder erstellt
	 *         (construktor) eine neu Datei im tsx/XML-Fromat. V: Das Objekt
	 ...
	 *         überschwimmbar 100 = überfliegbar 200 = Only Goast A: Schreibt
	 *         .tsx Datein im XML-Format
	 * 
	 */
	/**
	...
	@Deprecated
	public TileSetXML_outdated(File imageFile, String name, int tilewidth,
	...
	public TileSetXML_outdated(File imageFile, String name, int tilewidth, int tileheight) {
	...
	public TileSetXML_outdated(File f) {
		read(f);
	}
	...
	public Element getElements(Element root, Document xmlDoc, int firstgid,
		...
		image.setAttribute("source",imageFile.getPath());
		if (trans != null) {
			/* "004080" */
	...
	public void read(Element rootElement) {
		...
		this.imageFile = new File(fileRef);
		this.name = name;
		this.tilewidth = tileWidth;
		this.tileheight = tileHeight;
		try {
